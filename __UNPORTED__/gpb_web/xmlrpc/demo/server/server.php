...
ini_set('display_errors', 1); // put 0
...
in an alphabetic order.';
	...
	function findcategory($m) //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	{
        ...
        $query="SELECT * FROM jgpb_virtuemart_categories_it_it where virtuemart_category_id = $snv"; 
        ...
        if ($tot == 0) {
			$err="Error searching category ID '" . $snv . "'";
		}
		else{
		    $a=array();
		...
		return new xmlrpcresp(new xmlrpcval($a,	"struct"));
		//return new xmlrpcresp(new xmlrpcval($tot));
		...
		{
			return new xmlrpcresp(new xmlrpcval($name));
		}
	}
